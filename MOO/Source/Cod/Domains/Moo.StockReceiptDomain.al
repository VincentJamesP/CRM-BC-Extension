codeunit 70410 "Moo.StockReceiptDomain" implements "Moo.IDomain"
{
    var
    ...
    [ErrorBehavior(ErrorBehavior::Collect)]
    local procedure InsertStockReceipt(sourceData: JsonArray): JsonArray;
    var
        StockReceiptModel: Codeunit "Moo.StockReceiptModel";
        ProductQty: Integer;
        QtyCount: Integer;
        ...
        foreach LoopToken in ArrayToken.AsArray() do begin
            if LoopToken.IsObject() then begin
                ...
                if InvtDocHeaderTbl.FindFirst() then begin
                    ...
                    PostedHeaders.Add('ExternalDocNo', InvtDocHeaderTbl."External Document No.");
                    ...
                    foreach LineToken in Lines do begin
                        if LineToken.IsObject() then begin
                            ...
                            if InvtRecLineTbl.FindFirst() then begin
                                ...
                                PostedLine.Add('VariantCode', InvtRecLineTbl."Variant Code");
                                PostedLine.Add('Quantity', InvtRecLineTbl.Quantity);
