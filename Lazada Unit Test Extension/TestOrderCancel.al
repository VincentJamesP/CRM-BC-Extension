...
codeunit 70654 "Test - Lazada Cancel Order"
{
    Subtype = Test;
    ...
    begin
        Request := CancelOrderModel.MapRequestHeaders(CompanyID, CustomerNo, InvoiceNo);
    ...
    begin
        Response := APIHelper.CallWebservice(APIChannel::Lazada, APIFunction::LazadaOrderStatusCancelOrder, RequestModel, APIMethod::POST);
